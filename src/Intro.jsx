    ...
    return (
        <Paper elevation={3} sx={{ p: 2, width: "100%" }}>
            <p className="introTop">
                ...
                following the ratification of the new <a href="https://www.cge6069.org/wp-content/uploads/2024/12/CGE_2024-2027_Successor_Agreement-Changes-Noted.pdf">Collective Bargaining Agreement</a>.
            </p>
